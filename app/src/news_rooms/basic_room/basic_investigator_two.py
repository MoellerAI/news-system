...
class BasicInvestigatorTwo(BaseInvestigator):
    ...
    def __init__(self, name: str = "BasicInvestigatorTwo", journal_dir: str | None = "app/data"):
    ...
    def investigate(self, task: InvestigationTask) -> InvestigationTask:
        ...
        task.result = f"Alternative dummy result for task {task.task_id} from {self.name}"
        task.status = "done"
